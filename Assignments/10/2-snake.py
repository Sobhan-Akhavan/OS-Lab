import os
os.chdir('/home/sobhan/VisualStudioCode/OS-Lab/Assignments/10')
import random
import arcade

PEAR_PATH = "img/pear.png"
POOP_PATH = "img/poop.png"
...
class PEAR(arcade.Sprite):
    ...
    def __init__(self):
        ...
        texture = arcade.load_texture(PEAR_PATH)
...
class Poop(arcade.Sprite):
    ...
    def __init__(self):
        ...
        texture = arcade.load_texture(POOP_PATH)
